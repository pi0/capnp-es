...
export class TestImport extends capnp.Struct {
  ...
  adoptField(value: capnp.Orphan<TestAllTypes>): void {
    capnp.Struct.adopt(value, capnp.Struct.getPointer(0, this));
  }
  disownField(): capnp.Orphan<TestAllTypes> {
    return capnp.Struct.disown(this.getField());
  }
  ...
  getEnumField(): TestEnum {
    return capnp.Struct.getUint16(0, this) as TestEnum;
  }
