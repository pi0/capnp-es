...
export class TestImport extends capnp.Struct {
    static readonly _capnp = { displayName: "TestImport", id: "bc55b08b672b5d97", size: new capnp.ObjectSize(8, 1) };
    adoptField(value: capnp.Orphan<TestAllTypes>): void { capnp.Struct.adopt(value, capnp.Struct.getPointer(0, this)); }
    disownField(): capnp.Orphan<TestAllTypes> { return capnp.Struct.disown(this.getField()); }
    getField(): TestAllTypes { return capnp.Struct.getStruct(0, TestAllTypes, this); }
    hasField(): boolean { return !capnp.Struct.isNull(capnp.Struct.getPointer(0, this)); }
    initField(): TestAllTypes { return capnp.Struct.initStructAt(0, TestAllTypes, this); }
    setField(value: TestAllTypes): void { capnp.Struct.copyFrom(value, capnp.Struct.getPointer(0, this)); }
    getEnumField(): TestEnum { return capnp.Struct.getUint16(0, this); }
    setEnumField(value: TestEnum): void { capnp.Struct.setUint16(0, value, this); }
