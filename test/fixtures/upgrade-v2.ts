...
export class Upgrade extends capnp.Struct {
    static readonly _capnp = { displayName: "Upgrade", id: "8fa95f1989e267fb", size: new capnp.ObjectSize(8, 4) };
    ...
    getNewHotnessName(): string { return capnp.Struct.getText(3, this); }
    setNewHotnessName(value: string): void { capnp.Struct.setText(3, value, this); }
    getNewHotnessId(): number { return capnp.Struct.getInt32(4, this); }
    setNewHotnessId(value: number): void { capnp.Struct.setInt32(4, value, this); }
